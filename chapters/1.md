...
Next we will set the directory to where your Theos installation will be stored. For me I always install it to my home directory ```~``` to make navigating to it much easier. Let's create the terminal profile for quickly loading Theos. Open a new terminal window: 
